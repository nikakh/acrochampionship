...
?>
				...
				<div class="total">
					<h1 class="pass_title"><?= $sportsmen_day_2['action']?></h1>
					<h1 class="pass_score"><?= $A_score_2 + $E_score_2 + $sportsmen_day_2['difficulty'] - $sportsmen_day_2['penalty']?></h1>
				</div>
<?php
			}
			...
			$show_1 = $A_score_1 + $E_score_1 + $sportmsen['difficulty'] - $sportmsen['penalty'];
				 if($sportmsen['day_2'] != 0) {
					 $show_1 = $show_1 + $A_score_2 + $E_score_2 + $sportsmen_day_2['difficulty'] - $sportsmen_day_2['penalty'];
				 }
?>
<?php /*?>				<div class="total">
				<h1 class="pass_title">Total</h1>
				<h1 class="pass_score"><?php echo  $show_1 ?></h1><?php */?>
			</div>
